...
const float AMP_BASE = 0.5;  // steady glow that subset emits even when quiet -> near objects stay bathed in (and reflect) their nearby lights, not just the few currently flaring
